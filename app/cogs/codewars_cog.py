...
class CodewarsCog(commands.Cog):
    ...
    @commands.hybrid_command(name='cwuser', help="Get Codewars user information. Usage: +cwuser <username>")
    ...
    @commands.hybrid_command(name='cwcompleted', help="Show user's completed challenges. Usage: +cwcompleted <username>")
    ...
    @commands.hybrid_command(name='cwauthored', help="Show user's authored challenges. Usage: +cwauthored <username>")
    ...
    @commands.hybrid_command(name='kata', help="Get kata information. Usage: +kata <kata_name_or_slug>")
    ...
    @commands.hybrid_command(name='getkyu', help="Get a random kata of specific kyu level. Usage: +getkyu <1-8>")
    ...
    @commands.hybrid_command(name='cwbest', help="Show user's best/highest rated kata. Usage: +cwbest <username>")
    ...
    @commands.hybrid_command(name='randomkata', help="Get a random kata recommendation")
